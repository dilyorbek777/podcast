...
const Navbar = () => {
    ...
    return (
        <nav className="flex fixed backdrop-blur-2xl rounded-sd max-md:p-4 z-20 top-3 right-0 left-0 max-w-[1720px] w-full mx-auto items-center justify-between px-24 py-5">
            <Link href={'/'}>
            ...
            <div className={`nav-links max-w-[950px] w-full max-[1140px]:max-w-[600px]  flex items-center justify-between ${btn ? 'max-lg:flex absolute top-0 left-0 right-0 bottom-0 flex-col gap-5 h-screen items-center justify-center w-full max-lg:max-w-[768px] -z-10 bg-secondary' : 'max-lg:hidden'}`}>
